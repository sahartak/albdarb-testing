...
class View_load {
    ...
    public function load($view, $data=null, $header_data=array('title'=>'albdarb testing'), $footer_data=null) {
    ...
    public function view($view, $data=null, $header_data=array('title'=>'albdarb testing'), $footer_data=null) {
